(function(){
  ...
  const ASSET='./ines-official.webp?v=repair-20260821-1718';
  ...
  function installCss(){
    ...
    s.textContent=`
      ...
      #characters .hc-person[data-id='ines'] .fig{width:131%!important;height:93%!important;top:-2.5%!important;opacity:1!important;filter:none!important;overflow:hidden!important;border-radius:28px 28px 18px 18px!important;background:radial-gradient(circle at 48% 35%,rgba(255,255,255,.98) 0 28%,rgba(252,246,237,.95) 52%,rgba(244,232,217,.95) 100%)!important}
  ...
  function apply(){
    ...
    img.onerror=function(){ this.onerror=null; this.src='./ines-official.webp'; };
