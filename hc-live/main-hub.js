(function(){
  ...
  function ensureCharacters(){if(characterStarted)return;characterStarted=true;add('./character-interaction-prototype.js?v=3e30dd60','hcCharacterInteractionPrototypeScript');add('./character-focus-autohide.js?v=7593cf36','hcCharacterFocusAutohideScript');add('./character-focus-smart-position-v2.js?v=a1be592b','hcCharacterFocusSmartPositionV2Script')}
