(function(){
  ...
  function ensureCharacters(){if(characterStarted)return;characterStarted=true;add('./character-interaction-prototype.js?v=3e30dd60','hcCharacterInteractionPrototypeScript');add('./character-notebook-split-layout.js?v=1046df7a','hcCharacterNotebookSplitScript')}
