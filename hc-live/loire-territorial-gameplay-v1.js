/* Haute Couture Live — Loire territorial gameplay V1 */
(function(){
'use strict';
if(window.__HCLoireTerritorialGameplayV1)return;window.__HCLoireTerritorialGameplayV1=true;
...
window.HCLoireTerritorialGameplay={version:1,people,briefs,secrets,eventFamilies,meet,eventEdition,syncEvents,observeReference,state:read};syncEvents();
})();