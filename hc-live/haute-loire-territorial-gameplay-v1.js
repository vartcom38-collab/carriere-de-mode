/* Haute Couture Live — Haute-Loire territorial gameplay V1 */
(function(){
'use strict';
if(window.__HCHauteLoireTerritorialGameplayV1)return;window.__HCHauteLoireTerritorialGameplayV1=true;
...
window.HCHauteLoireTerritorialGameplay={version:1,people,briefs,secrets,eventFamilies,meet,eventEdition,syncEvents,observeReference,state:read};syncEvents();
})();