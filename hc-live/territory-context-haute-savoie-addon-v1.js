/* Haute Couture Live — correctif chargement territorial Haute-Savoie 74 V3
   Focus carte != déplacement. Chargement séquentiel + attente explicite de HCLocalMap.
   V3 : réutilisation sûre des scripts déjà injectés par le runtime générique.
*/
(function(){'use strict';if(window.__HCTerritoryContextHauteSavoieAddonV3)return;window.__HCTerritoryContextHauteSavoieAddonV3=true;
...
function alreadyReady(id){
 const checks={
  ...
  hcTerritoryGameplayScript74:()=>!!window.HCHauteSavoieTerritorialGameplay,
  hcTerritoryMapPack74:()=>!!window.__HCHauteSavoieMapContentV1
 };
