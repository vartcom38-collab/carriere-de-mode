/* Haute Couture Live — Haute-Loire dense universe V2 */
(function(){
'use strict';
if(window.__HCHauteLoireDenseUniverseV2)return;window.__HCHauteLoireDenseUniverseV2=true;
...
'Retournac':[
{id:'hl43-retournac-manufacture',name:'Retournac · manufacture & mémoire dentellière',cat:'fabric',lat:45.205,lng:4.034,image:commons('Musée des dentelles à retournac.jpg'),imageSource:'Wikimedia Commons — Musée des dentelles à retournac.jpg',text:'Le Musée des Manufactures de Dentelles conserve dans son bâtiment d’origine un ensemble industriel exceptionnel : plus de 450 000 pièces, archives de fabriques, dessins, dentelles à la main et machines de dentelle mécanique. La visite nourrit observation, mise en carte, mémoire du travail et recherche de construction textile.',materials:['dentelle','fils','cartons'],motifs:['dessins techniques','réseaux'],palette:['écru','bleu passé','gris machine'],meta:{documentary:true,sourceLabel:'Ville de Retournac — Musée des Manufactures de Dentelles',sourceUrl:'https://www.ville-retournac.fr/musee-des-manufactures-de-dentelles-mairie-retournac-43'}}
],
...
window.HCHauteLoireDenseUniverse={version:2,universes:U};window.dispatchEvent(new CustomEvent('hc-haute-loire-dense-universe-ready',{detail:window.HCHauteLoireDenseUniverse}));
})();