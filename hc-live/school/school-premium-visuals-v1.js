...
if(arrival&&arrival.phase!=='done'&&/\/school-(home|day|welcome|tour)\/?$/.test(path)&&!window.HCSchoolArrivalFocusV1&&!document.querySelector('script[data-hc-arrival-focus]')){
  ...
  const s=document.createElement('script');s.src=base+'school/school-arrival-focus-v1.js?v=20260906-focus3';s.defer=true;s.setAttribute('data-hc-arrival-focus','1');document.head.appendChild(s);
}
