...
const A={
 ...
 'loire-firminy':'lr42-firminy','ste3-firminy':'lr42-firminy','lo42-firminy-modulor':'lr42-firminy','loire-feurs':'lr42-feurs','lo42-feurs-marche':'lr42-feurs',
 'lo42-map-sbc':'lr42-saint-bonnet','lo42-sbc-artisanat':'lr42-saint-bonnet','lo42-map-boen':'lr42-boen','lo42-boen-forez':'lr42-boen','lo42-map-noiretable':'lr42-noiretable','lo42-noiretable-foret':'lr42-noiretable','lo42-map-sg':'lr42-saint-galmier','lo42-sg-eau':'lr42-saint-galmier',
 ...
 'rh-tarare':'lr69-tarare','rh-dense-tarare-voilage':'lr69-tarare','tier2-tarare-0':'lr69-tarare','tier2-tarare-1':'lr69-tarare','tier2-tarare-8':'lr69-tarare','rh-map-amplepuis':'lr69-amplepuis','rh-map-thizy':'lr69-thizy','rh-dense-thizy-manufacture':'lr69-thizy'
};
...
function wrapMap(map){if(!map?.addMarker||map.__hcLoireRhoneEnriched)return;const add=map.addMarker.bind(map);map.addMarker=p=>add(enrich(p));map.__hcLoireRhoneEnriched=true;}
wrapMap(window.HCLocalMap);
